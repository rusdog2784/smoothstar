        ...
        <Content showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.cardsViewStyle}>
            <CardRI
              ...
              subText="3 x Videos">
              New to SmoothStar? folllow our guide on how to get started by expert SmoothStar
              coaches.
            </CardRI>

            <CardRI
              onPress={() => this.props.navigation.navigate('RegistrationStack')}
              imgSource={Assets.Images.initSlider3}
              heading="REGISTER NOW"
              subText={Moment(Date.now()).format('DD MMM YYYY')}>
              Get an extra 3 months warranty when you register your SmoothStar on the app.
            </CardRI>
          </View>
        </Content>
      </Container>
